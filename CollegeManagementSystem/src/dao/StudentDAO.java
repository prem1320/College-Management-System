...
public class StudentDAO {
    ...
    public boolean addStudent(String rollNumber, String name, String email, int courseId, int yearNumber) {
        String query = "INSERT INTO students (roll_number, name, email, course_id, year_number) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean updateStudent(Student student) {
        String sql = "UPDATE students SET name = ?, email = ?, course_id = ?, year_number = ? WHERE roll_number = ?";
        try (Connection conn = DBConnection.getConnection();
